...
from utils.utils import instantiate_from_config, exists, default
...
def nonlinearity(type="silu"):
    """References:
    https://github.com/VideoCrafter/VideoCrafter/blob/main/lvdm/models/modules/util.py#L249
    """
    if type == "silu":
        return nn.SiLU()
...
class GEGLU(nn.Module):
    """References:
    https://github.com/VideoCrafter/VideoCrafter/blob/main/lvdm/models/modules/util.py#L256
    """
...
def Normalize(in_channels):
    """References:
    https://github.com/VideoCrafter/VideoCrafter/blob/main/lvdm/models/modules/util.py#L198
    """
...
def random_temporal_masking(
    ...
    """
    """References:
    https://github.com/YingqingHe/LVDM/blob/main/lvdm/models/modules/util.py#L33
    """
    if p_pred == 0.0:
        n_prevs = None
...
def make_interp_mask_with_bothsidescond(t, device, n_interp1, n_interp2):
    ...
    """
    """References:
    https://github.com/YingqingHe/LVDM/blob/main/lvdm/models/modules/util.py#L15
    """
...
def make_interp_mask_with_framestride(t, device, frame_stride):
    ...
    """
    """References:
    https://github.com/YingqingHe/LVDM/blob/main/lvdm/models/modules/util.py#L24
    """
    mask = torch.zeros([t], device=device)
